...
import com.example.mvi_newsapp_jetpackcompose.features.b_breakingnews.presentastion.ArticleCardComposable

@Composable
fun SearchNewsScreenUI(viewModel:SearchNewsViewModel,onArticleClick: (String) -> Unit) {
